...
-- Insert sample data
INSERT INTO doctors (user_id, name, email, phone, specialization, qualifications, experience_years, license_number, registration_number, chamber_address) VALUES
(uuid_generate_v4(), 'ডাঃ মোহাম্মদ আলী', 'doctor@homeocare.com', '+8801XXXXXXXXX', 'Homeopathy', ARRAY['DHMS', 'BHMS', 'MD (Homeopathy)'], 20, 'DHMS-54321', 'BMDC-12345', '১২৩ মেইন রোড, ঢাকা - ১২০০');

INSERT INTO medicines (name, category, brand, price, original_price, description, stock_quantity) VALUES
('Arsenicum Album 30', 'acute', 'Hahnemann', 120, 140, 'গ্যাস্ট্রিক, ডায়রিয়া এবং অস্থিরতার জন্য', 50),
('Nux Vomica 200', 'chronic', 'Reckeweg', 150, 180, 'বদহজম, কোষ্ঠকাঠিন্য এবং অ্যাসিডিটির জন্য', 30),
('Chamomilla 30', 'children', 'SBL', 110, 130, 'শিশুদের দাঁত ওঠা এবং কান্নাকাটির জন্য', 25),
('Sepia 200', 'women', 'Hahnemann', 165, 190, 'নারীদের হরমোনাল সমস্যা এবং মানসিক অবসাদ', 0),
('Sulphur 30', 'skin', 'Reckeweg', 135, 155, 'চর্মরোগ, একজিমা এবং চুলকানির জন্য', 40),
('Lycopodium 200', 'chronic', 'SBL', 145, 170, 'লিভার, কিডনি এবং হজমের সমস্যার জন্য', 35);
